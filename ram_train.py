import numpy as np
from ram_other import DeepQAgent, env_make
...
env = env_make('BeamRider-ram-v4', 'gym', 4)
agent = DeepQAgent(alpha=LEARNING_RATE, gamma=DISCOUNTING_RATE, n_actions=env.action_space.n, memory_size=MEMORY_SIZE,
                   batch_size=BATCH_SIZE, input_dims=(1024,), eps=EPS, eps_dec=EPS_DEC, eps_min=EPS_MIN,
                   main_name="ram_main.h5", target_name="ram_target.h5")
